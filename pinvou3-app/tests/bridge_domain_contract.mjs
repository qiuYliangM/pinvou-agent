export const desktopBridgeApi = {
  ...
  chat: ['cancelGeneration', 'cancelShellTask', 'getComposerDraft', 'interruptAndSend', 'prefillComposer', 'removeQueued', 'retryFirstTurn', 'sendMessage', 'sendMessageToSession', 'setComposerDraft', 'steer'],
...
export const desktopOnlyBridgeApi = {
  ...
  // mid-turn inject + interrupt 走底座 EnginePool,需要 Tauri 命令通道;
  // Web 端无 backend
  chat: ['steer', 'interruptAndSend'],
};
